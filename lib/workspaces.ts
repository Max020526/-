...
export type FrontendProduct = {
  id: "warehouse-pos" | "internal-admin" | "retail-storefront" | "b2b-portal";
  eyebrow: string;
  title: string;
  description: string;
  scope: string;
...
export const FRONTEND_PRODUCTS: FrontendProduct[] = [
  {
    id: "warehouse-pos",
    eyebrow: "WAREHOUSE & POS PWA",
    title: "仓库与门店作业",
    description: "员工在一个移动端完成快速入库、货单收货、履约拣货、门店销售和库存查询。",
    scope: "P01 入库 · P04 履约 · P08 POS",
    href: "/warehouse",
    status: "active",
    tone: "mint",
    icon: PackageCheck,
  },
  {
    ...
    title: "内部经营管理",
    description: "老板和管理员统一管理商品、订单、采购、财务、经营分析与系统设置。",
    scope: "P02 商品 · P03 订单 · P05 采购 · P06 财务 · P07 老板 · P09 系统",
    href: "/admin",
    status: "active",
    tone: "blue",
    icon: Boxes,
  },
  {
    ...
    eyebrow: "RETAIL STOREFRONT",
    title: "零售顾客网站",
    description: "独立面向顾客的品牌商城，只读取管理端已经审核并发布的商品和可售库存。",
    scope: "C01 独立顾客端",
    href: RETAIL_STOREFRONT_URL,
    external: true,
    status: "active",
    tone: "amber",
    icon: ExternalLink,
  ...
  {
    id: "b2b-portal",
    eyebrow: "B2B PORTAL · OPTIONAL",
    title: "批发客户门户",
    description: "预留批发客户询价、下单和账期功能；V1.0 不启用，不阻塞当前系统上线。",
    scope: "C02 后续按业务量启用",
    status: "optional",
    tone: "slate",
    icon: Building2,
...
export type WorkspaceDefinition = {
  code: string;
  title: string;
  owner: "warehouse" | "admin" | "customer";
  description: string;
  href?: string;
...
export const WORKSPACES: WorkspaceDefinition[] = [
  ...
  { code: "P04", title: "仓库履约", owner: "warehouse", description: "拣货、复核、打包、出库和异常处理。", href: "/warehouse/fulfillment", status: "planned", icon: Truck },
