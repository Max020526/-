...
export default function WarehouseHome(){
 ...
 return <main className="page"><PageHead eyebrow="WAREHOUSE OVERVIEW" title="早上好，准备收货" subtitle="从原始货单开始，准确记录今天的每一件新货。" action={<Link className="button primary" href="/warehouse/receipts/new"><Plus size={16}/>新建入库单</Link>}/><SetupBanner/>
