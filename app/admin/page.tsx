...
export default function AdminDashboard() {
  ...
  return <main className="page">
    ...
    <section className="panel" style={{ marginBottom: 18 }}><div className="panel-head"><div><h2>入库快捷入口</h2><p>仓库员工最常用操作</p></div></div><div className="panel-body" style={{ display: "flex", gap: 10, flexWrap: "wrap" }}><Link className="button primary" href="/inbound/new">快速入库</Link><Link className="button" href="/inbound/batch">批量入库</Link><Link className="button" href="/inbound/today">今日入库</Link><Link className="button" href="/admin/products/pending">待完善商品</Link><Link className="button" href="/admin/inventory">库存查询</Link></div></section>
