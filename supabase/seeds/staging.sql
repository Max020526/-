...
values ('00000000-0000-4000-8000-000000000101', 'TEST-NEXORA', 'NEXORA STAGING TEST')
...
on conflict (slug) do update set name_zh = excluded.name_zh, is_active = true;
...
on conflict (name) do update set name_zh = excluded.name_zh, is_active = true;
...
on conflict (normalized_name) do update set hex_value = excluded.hex_value, is_active = true;
...
on conflict (sku) do update set is_active = true, is_visible_online = true;
